...
export interface PRData {
  ...
  noPRFinal?: string;
  unitPemohonan?: string;
  tanggalOE?: string;
  hps?: string;
  hargaNegosiasi?: string;
}
...
interface PRFormProps {
  ...
  initialData?: Partial<PRData> | null;
}
...
export function PRForm({ open, onClose, onSubmit, initialData }: PRFormProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {initialData ? "Edit" : "Add New"} Purchase Request
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, namaPengadaan: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, statusPengadaan: value })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, noPRFinal: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, unitPemohonan: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, tanggalOE: e.target.value })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={formData.hps}
                  onChange={(e) =>
                    setFormData({ ...formData, hps: e.target.value })
                  }
